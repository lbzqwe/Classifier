...
def PredictTrials(clf,X, y, fitter, data):
    ...
    for k in range(10):
        ...
        # Fit the data
        reg = fitter(clf,X_train, y_train)
        ...
        # Result
        # print(pred)
        print("Trial {}: ${}".format(k+1, pred))

    # Display price range
    print("\nRange in prices: ${}".format(max(prices) - min(prices)))
